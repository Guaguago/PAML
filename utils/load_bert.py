...
class bert_model(object):
    def __init__(self):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', cache_dir='pretrained/BertTokenizer',
                                                       do_lower_case=True)
        ...
        model = BertForSequenceClassification.from_pretrained('bert-base-uncased',
                                                              cache_dir='pretrained/BertForSequenceClassification',
    ...
    def predict_label(self, turn, personas_items):
        ...
        eval_features = convert_examples_to_features(eval_examples, self.label_list, self.max_seq_length,
                                                     self.tokenizer)
